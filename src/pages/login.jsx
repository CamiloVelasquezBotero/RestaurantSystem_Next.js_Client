    ...
    <Layout>
      <div className="md:grid grid-cols-2 bg-white">
        ...
        <div className="mx-10 flex flex-col mt-5">
          ...
          {isLoading && (
            <div className="bg-blue-100 border-l-4 border-blue-500 text-blue-700 p-4 mt-5 rounded-md shadow-sm flex items-center gap-3">
              <div className="w-5 h-5 border-2 border-blue-600 border-t-transparent rounded-full animate-spin"></div>
              <div>
                <p className="font-bold">Conectando con el servidor...</p>
          ...
          >
            ...
            <input
              type="submit"
              className={`p-2 mt-5 font-bold bg-orange-700 rounded-lg text-white text-xl duration-200 ${isLoading ? 'opacity-50 cursor-not-allowed' : 'cursor-pointer hover:bg-orange-800'}`}
